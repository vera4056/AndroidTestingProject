...
public class MainMenu {
    ...
    public static ViewInteraction textMenuButton = onView(withContentDescription("Main menu"));
    public static ViewInteraction missionButton = onView(withId(R.id.our_mission_image_button));
    public static ViewInteraction textMissionButton = onView(withContentDescription("Our Mission"));
    public static ViewInteraction authorizationButton = onView(withId(R.id.authorization_image_button));
    public static ViewInteraction textAuthorizationButton = onView(withContentDescription("Authorization"));
