...
public class News {
    ...
    public static ViewInteraction  addNewsButton = onView(withContentDescription("Add news button"));
    public static ViewInteraction  categoryButton = onView(withContentDescription("Show dropdown menu"));
    public static ViewInteraction  categoryText = onView(withText("Объявление"));
